...
class Command[**P, R]:
    ...
    def __call__(self, *args: P.args, **kwargs: P.kwargs) -> Command[P, R]:
        self.args = args
        self.kwargs = kwargs
        return self
    
def command[**P, R](callback: Callable[P, R]) -> Command[P, R]:
...
class CommandManager:
    ...
    def execute(self, command: Command[[int], Any]) -> Any | None:
